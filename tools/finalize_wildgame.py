...
ADDED = [
    ...
    make(
        ...
        MO,
        ["1 whole rabbit, cut into pieces", "1 package sliced button mushrooms",
         "14 oz can diced Italian-seasoned tomatoes, drained", "12 oz cooked pasta (rotini or fettuccini)",
         "3 tablespoons flour", "2 teaspoons chopped garlic", "1/4 teaspoon salt", "1/4 teaspoon pepper",
         "2 tablespoons olive oil", "2 tablespoons tomato paste", "1 cup chopped onion",
         "Dry white wine (as needed to deglaze, about 1/2 cup)"],
        ["Dust rabbit with flour enough to coat; season with salt and pepper.",
         "In a skillet, heat olive oil over medium-high heat. Add rabbit and cook about 3 minutes per side; remove and set aside.",
         "Add onions, mushrooms, and garlic; reduce heat to medium and cook 5 minutes, stirring occasionally.",
         "Add drained tomatoes, wine, and tomato paste; bring to a boil.",
         "Tuck rabbit into the sauce. Cook on medium-low, partially covered, about 8 minutes until tender.",
    ...
    make(
        ...
        ["Partially freeze venison and slice across the grain into bite-size strips.",
         "Stir together sour cream and flour; stir in water, bouillon, salt, and pepper.",
         "In a large skillet, cook and stir the meat in hot butter until done; remove.",
         "Add mushrooms, onion, and garlic; cook and stir until done. Return the meat.",
         "Stir the sour cream mixture into the skillet. Cook and stir until thick and bubbly. Serve over noodles."],
        40, 4, 2, ["big-game"],
    ),
    make(
    ...
    make(
        ...
        MO,
        ["Squirrels, boiled or pressure-cooked until tender, meat removed from the bone",
         "Favorite pie crust recipe, enough for bottom and top",
         "1 can corn", "1 can peas", "1 medium onion, diced", "1 cup diced cooked potatoes"],
        ["Season and boil or pressure-cook squirrels as for dumplings. Remove meat from the bone.",
         "Make pie crust and line a small to medium square cake pan.",
         "Mix squirrel meat with corn, peas, diced onion, and cooked potatoes. Pour filling over the bottom crust.",
         "Cover with a top crust, punch holes, and bake until golden brown. Serve."],
        90, 6, 2, ["small-game"],
    ),
    make(
        "Venison Chili (Texas Parks & Wildlife)", "venison", ["venison"],
        "https://tpwd.texas.gov/huntwild/hunt/wildgame-recipes/venison_chili.phtml",
        TX,
        ["1/4 cup vegetable oil", "2 lbs venison", "Salt and pepper to taste",
         "2 poblano peppers, stemmed and diced", "1/2 large onion, chopped", "5 cloves garlic, chopped",
         "1 1/2 tablespoons ancho chile powder", "2 teaspoons cayenne pepper, or to taste",
         "1 tablespoon ground cumin", "1/2 teaspoon oregano", "1 can black beans", "1 can chili beans",
         "1 can diced tomatoes", "2 cups game stock or chicken broth"],
        ["Brown venison on medium-high heat with a little oil in a Dutch oven or large cast iron. Season with salt and pepper.",
         "When browned, transfer meat to a bowl.",
         "Add remaining oil, reduce to medium, and cook poblanos and onion until soft.",
         "Raise heat to medium-high; add garlic, ancho chile powder, cayenne, cumin, and oregano. Stir 1 minute.",
         "Add beans, tomatoes, stock, and venison. Bring to a simmer and cook partially covered, stirring occasionally, 2 hours.",
         "Serve with cheese, sour cream, onions, or corn chips."],
        150, 7, 2, ["big-game"],
    ),
    make(
